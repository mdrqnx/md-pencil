...
//
// 두 상수가 손맛을 정합니다. 글씨를 쓰는 속도대(200~800 px/s)에서는 BETA*속도 가
// MIN_CUTOFF 를 훨씬 웃돌므로, 실제로 손맛을 좌우하는 것은 BETA 쪽입니다.
//   MIN_CUTOFF : 아주 느린 구간에만 영향을 줍니다
//   BETA       : 낮출수록 전반적으로 매끄러워지고, 높일수록 지연이 줄어듭니다
const OE_MIN_CUTOFF = 2.0;
const OE_BETA       = 0.046;
